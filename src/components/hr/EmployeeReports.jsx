...
const employeeReports = [
  { id: 'EMP001', name: 'Alex Dwayne Johnson', position: 'Senior Developer', flagged: false },
  { id: 'EMP002', name: 'Sarah Williams', position: 'Product Manager', flagged: true },
  { id: 'EMP003', name: 'Michael Jordan Chen', position: 'UI/UX Designer', flagged: false },
  { id: 'EMP004', name: 'Emily Davis', position: 'Marketing Specialist', flagged: false },
  { id: 'EMP005', name: 'Robert Louis Taylor', position: 'System Analyst', flagged: true },
  { id: 'EMP006', name: 'Jennifer Bruce Lee', position: 'Data Scientist', flagged: false },
  { id: 'EMP007', name: 'David Harvey Wilson', position: 'Project Manager', flagged: true },
];
    ...
    <Card className="shadow-card bg-card border border-hr-green/20">
      ...
      <CardContent>
        <Tabs defaultValue="all" className="w-full" onValueChange={setActiveTab}>
          <TabsList className="w-full mb-4 grid grid-cols-3 gap-1 sm:gap-2 md:gap-3 bg-transparent border-0 shadow-none p-0" style={{ backgroundColor: 'transparent' }}>
            <TabsTrigger 
              value="all" 
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-hr-green/20">
                    <TableHead className="text-hr-green w-[130px]">Employee ID</TableHead>
                    <TableHead className="text-hr-green w-[150px] md:w-[170px]">Name</TableHead>
                    <TableHead className="text-hr-green w-[150px] md:w-[180px]">Position</TableHead>
                    <TableHead className="text-hr-green w-[100px]">Status</TableHead>
                    <TableHead className="text-center text-hr-green w-[100px]">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>

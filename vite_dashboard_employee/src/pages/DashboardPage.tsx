        ...
        <div className="absolute top-4 right-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              {/* <Button
                variant="ghost"
                className="p-2 hover:bg-transparent focus:bg-transparent transition-none border-transparent"
              > */}
            ...
            <DropdownMenuContent className="w-56" align="end">
              ...
              <DropdownMenuItem
                className="cursor-pointer text-destructive hover:bg-background/50 transition-colors focus:text-destructive"

// src/components/history/ConversationListItem.jsx
...
const ConversationListItem = ({ conversation }) => {
  ...
  return (
    <div className="flex items-start p-3 rounded-lg cursor-pointer transition duration-100 hover:bg-[rgba(38,137,13,0.3)]">
